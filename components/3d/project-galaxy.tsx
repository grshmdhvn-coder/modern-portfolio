...
const projectsData = [
  {
    id: 1,
    name: "Predictive Maintenance using Vibration and Temperature Sensors",
    category: "ai",
    position: [2, 1, 0],
    color: "#00ffff",
    description: "Machine learning system for predicting equipment failures using vibration and temperature sensor data.",
  ...
  {
    id: 2,
    name: "Article Image Generation",
    category: "ai",
    position: [-2, -1, 1],
    color: "#ff00ff",
    description: "AI-powered system for automatic image generation from text articles.",
  ...
  {
    id: 3,
    name: "Solid Modeling and Simulation",
    category: "engineering",
    position: [0, 2, -2],
    color: "#ffff00",
    description: "3D modeling and simulation of mechanical components and systems.",
    technologies: ["CAD", "Simulation", "Engineering"],
    github: "https://github.com",
    demo: "https://demo.com",
    image: "/placeholder.svg?height=200&width=300",
  },
  {
    ...
    position: [-1, 0, 2],
    color: "#00ff00",
    description: "NLP-based sentiment analysis for analyzing customer product reviews.",
  ...
  {
    id: 5,
    name: "Effect of Injection Pressure on Vibration, Noise, and Performance Analysis of Diesel Engine Using Coconut Biodiesel and Its Blends",
    category: "engineering",
    position: [1, -1, -1],
    color: "#ff0000",
    description: "Bachelor thesis on diesel engine performance analysis using coconut biodiesel.",
    technologies: ["Mechanical Engineering", "Biodiesel", "Performance Analysis"],
    github: "https://github.com",
    demo: "https://demo.com",
    image: "/placeholder.svg?height=200&width=300",
  },
