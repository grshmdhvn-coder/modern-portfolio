...
const skillsData = [
  {
    ...
    color: "#3776AB",
    position: [3, 0, 0],
    description: "Programming language for AI, data analysis, and automation",
  },
  {
    name: "C",
    category: "Programming",
    ...
    color: "#A8B9CC",
    position: [2.1, 2.1, 0],
    description: "Low-level programming for system and embedded applications",
  },
  {
    ...
    color: "#0696D7",
    position: [0, 3, 0],
    description: "3D CAD software for design and simulation",
  },
  {
    name: "SolidWorks",
    category: "CAD",
    ...
    color: "#DC143C",
    position: [-2.1, 2.1, 0],
    description: "Mechanical design and engineering software",
  },
  {
    name: "CATIA V6",
    category: "CAD",
    ...
    color: "#005387",
    position: [-3, 0, 0],
    description: "Advanced CAD software for complex engineering designs",
  },
  {
    name: "AutoCAD",
    category: "CAD",
    ...
    color: "#0696D7",
    position: [-2.1, -2.1, 0],
    description: "2D and 3D drafting and design software",
  },
  {
    name: "MS Word",
    category: "MS Office",
  ...
  },
  {
    ...
    color: "#217346",
    position: [2.1, -2.1, 0],
    description: "Spreadsheet and data analysis tool",
  },
  {
    name: "MS PowerPoint",
    category: "MS Office",
